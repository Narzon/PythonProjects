#  File: Bowling.py
#  Description: Reading a file of bowling scores, calculate running totals for each time
...
#Create a list, stval, to keep track of the integer values for each string character (for use during calculations)
   stval = []
